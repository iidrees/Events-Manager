...
describe('Sign-up and Sign-in Endpoints', () => {
  describe('Test Sign-up "/api/v1/users" endpoint', () => {
    it('should return "Please enter a password" when a user enters no password',
     (done) => {
      request(app)
        .post('/api/v1/users')
        .send({
    ...
    it('should return "Please your password do not match"'+
    'when a user enters no password confirmation', (done) => {
      request(app)
        .post('/api/v1/users')
        .send({
          name: 'Idrees',
    ...
    it('should return "Password cannot be less than 8 characters"'+
    'when a user enters password less than 8 characters', (done) => {
      request(app)
        .post('/api/v1/users')
        .send({
          name: 'Idrees',
    ...
    it('should return status "Success" for a successful sign-up'+
    'when a user enters all input fields correctly', (done) => {
      request(app)
        .post('/api/v1/users')
        .send({
          name: 'tester',
    ...
    it('should return "name already exists" when a user enters'+
    ...
    it('should return "Please enter your email address"'+
      'when a user enters omits email', (done) => {
      request(app)
        .post('/api/v1/users')
        .send({
          name: 'tester',
    ...
    it('should return "the email already exists, enter a new email" '+
     'when a user enters an existing email in the db', (done) => {
      request(app)
        .post('/api/v1/users')
        .send({
          name: 'idrees',
  ...
  describe('Test sign-in "/api/v1/users/login" endopoint', () => {
    ...
    it('Should return "Please enter your password"'+
    ' when a user enters no password', (done) => {
      request(app)
        .post('/api/v1/users/login')
        .send({
          email: 'tester@gmail.com',
    ...
    it('Should return "Success" for token generation'+
    ' after a user enters correct login details', (done) => {
      request(app)
        .post('/api/v1/users/login')
        .send({
          email: 'tester@gmail.com',
    ...
    it('Should return "Success" for superAdmin token generation'+
    ' when a superAdmin supply correct login details', (done) => {
      request(app)
        .post('/api/v1/users/login')
        .send({
    ...
    it('Should return "Email or Password is invalid"'+
     ' when a user enters wrong password', (done) => {
      request(app)
        .post('/api/v1/users/login')
        .send({
          email: 'tester@gmail.com',
...
describe('TEST FOR ADMIN', () => {
  describe('Test creation of an admin', () => {
    ...
    it('Should return "Success" for signin'+
    ' when an upgraded user re-log in', (done) => {
      request(app)
        .post('/api/v1/users/login')
        .send({
          email: 'tester@gmail.com',
